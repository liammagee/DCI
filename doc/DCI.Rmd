...
The percentage of reported urban residents here is `r format(length(data[data$location == 2] / length(data)), width = 2, format = "d", flag = "0")` - considerably less than [World Bank figures of 89%](http://data.worldbank.org/indicator/SP.URB.TOTL.IN.ZS).
...
```{r graphSubQuestion74, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion431, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion437, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion341, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion352, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion353, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion430, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion435, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion428, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion343, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion287, fig.width = 8, fig.height = 8, echo=FALSE}
...
```{r graphSubQuestion429, fig.width = 8, fig.height = 8, echo=FALSE}
