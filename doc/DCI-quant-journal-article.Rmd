...
d.pca$relative.variance <- d.pca$sdev**2 / sum.variances * 100
...
dt.pca$relative.variance <- dt.pca$sdev**2 / sum.variances * 100
...
## The Capacities of Australian Households

TBD


## Towards a Theory of Digital Capacity Measurement
